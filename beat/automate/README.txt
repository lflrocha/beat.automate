...
The Congresso Programacao content type
===============================

In this section we are tesing the Congresso Programacao content type by performing
basic operations like adding, updadating and deleting Congresso Programacao content
items.

Adding a new Congresso Programacao content item
--------------------------------
...
'Congresso Programacao' and click the 'Add' button to get to the add form.

    >>> browser.getControl('Congresso Programacao').click()
    >>> browser.getControl(name='form.button.Add').click()
    >>> 'Congresso Programacao' in browser.contents
    True

Now we fill the form and submit it.

    >>> browser.getControl(name='title').value = 'Congresso Programacao Sample'
    >>> browser.getControl('Save').click()
    >>> 'Changes saved' in browser.contents
    True

And we are done! We added a new 'Congresso Programacao' content item to the portal.

Updating an existing Congresso Programacao content item
---------------------------------------

Let's click on the 'edit' tab and update the object attribute values.

    >>> browser.getLink('Edit').click()
    >>> browser.getControl(name='title').value = 'New Congresso Programacao Sample'
    >>> browser.getControl('Save').click()
...
We check that the changes were applied.
    ...
    >>> 'Changes saved' in browser.contents
    True
    >>> 'New Congresso Programacao Sample' in browser.contents
    True

Removing a/an Congresso Programacao content item
--------------------------------

If we go to the home page, we can see a tab with the 'New Congresso Programacao
...
Now we are going to delete the 'New Congresso Programacao Sample' object. First we
go to the contents tab and select the 'New Congresso Programacao Sample' for
deletion.

    >>> browser.getLink('Contents').click()
    >>> browser.getControl('New Congresso Programacao Sample').click()
...
So, if we go back to the home page, there is no longer a 'New Congresso Programacao
Sample' tab.
...
Adding a new Congresso Programacao content item as contributor
------------------------------------------------

Not only site managers are allowed to add Congresso Programacao content items, but
...
We select 'Congresso Programacao' and click the 'Add' button to get to the add form.
...
Done! We added a new Congresso Programacao content item logged in as contributor.
...
The Programacao content type
===============================

In this section we are tesing the Programacao content type by performing
basic operations like adding, updadating and deleting Programacao content
items.

Adding a new Programacao content item
--------------------------------
...
Then we select the type of item we want to add. In this case we select
'Programacao' and click the 'Add' button to get to the add form.

    >>> browser.getControl('Programacao').click()
    >>> browser.getControl(name='form.button.Add').click()
    >>> 'Programacao' in browser.contents
    True

Now we fill the form and submit it.

    >>> browser.getControl(name='title').value = 'Programacao Sample'
    >>> browser.getControl('Save').click()
    >>> 'Changes saved' in browser.contents
    True

And we are done! We added a new 'Programacao' content item to the portal.

Updating an existing Programacao content item
---------------------------------------

Let's click on the 'edit' tab and update the object attribute values.

    >>> browser.getLink('Edit').click()
    >>> browser.getControl(name='title').value = 'New Programacao Sample'
    >>> browser.getControl('Save').click()
...
We check that the changes were applied.
    ...
    >>> 'Changes saved' in browser.contents
    True
    >>> 'New Programacao Sample' in browser.contents
    True

Removing a/an Programacao content item
--------------------------------

If we go to the home page, we can see a tab with the 'New Programacao
Sample' title in the global navigation tabs.
...
Now we are going to delete the 'New Programacao Sample' object. First we
go to the contents tab and select the 'New Programacao Sample' for
deletion.

    >>> browser.getLink('Contents').click()
    >>> browser.getControl('New Programacao Sample').click()
...
So, if we go back to the home page, there is no longer a 'New Programacao
Sample' tab.
...
Adding a new Programacao content item as contributor
------------------------------------------------

Not only site managers are allowed to add Programacao content items, but
also site contributors.
...
We select 'Programacao' and click the 'Add' button to get to the add form.
...
Done! We added a new Programacao content item logged in as contributor.
